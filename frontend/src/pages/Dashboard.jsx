  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0f172a', display: 'flex' }}>
      ...
      <div style={{ flex: 1, padding: '30px', overflowY: 'auto' }}>
        ...
        {activeTab === 'dashboard' && (
          <div>
            <h1 style={{ fontSize: '24px', fontWeight: '700', color: '#f1f5f9', marginBottom: '8px' }}>Dashboard 📊</h1>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(160px, 1fr))', gap: '16px', marginBottom: '30px' }}>
              {[
                ...
                <div key={stat.label} style={{ background: stat.bg, borderRadius: '16px', padding: '20px', border: `1px solid ${stat.color}33` }}>
        ...
        {activeTab === 'tasks' && (
          <div>
            <h1 style={{ fontSize: '24px', fontWeight: '700', color: '#f1f5f9', marginBottom: '8px' }}>My Tasks ✅</h1>
            ...
            <div style={{ background: '#1e293b', padding: '20px', borderRadius: '16px', marginBottom: '20px' }}>
              <div style={{ display: 'flex', gap: '10px', flexWrap: 'wrap' }}>
                <input
                  ...
                  style={{ flex: 1, minWidth: '200px', background: '#0f172a', border: '1px solid #334155', color: '#e2e8f0', padding: '10px 14px', borderRadius: '8px' }}
                />

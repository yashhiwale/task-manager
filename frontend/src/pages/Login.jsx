  ...
  return (
    <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0f172a' }}>
      <div style={{ background: '#1e293b', padding: '40px', borderRadius: '16px', width: '100%', maxWidth: '400px', boxShadow: '0 25px 50px rgba(0,0,0,0.5)' }}>
        <h2 style={{ textAlign: 'center', marginBottom: '8px', fontSize: '28px', color: '#f1f5f9' }}>Welcome Back 👋</h2>
        <p style={{ textAlign: 'center', color: '#94a3b8', marginBottom: '30px' }}>Login to your account</p>
        ...
        <button onClick={handleLogin} style={{ width: '100%', background: '#6366f1', color: 'white', fontSize: '16px', padding: '12px', borderRadius: '8px', border: 'none', cursor: 'pointer' }}>
          Login →
        </button>

        <p style={{ textAlign: 'center', marginTop: '20px', color: '#94a3b8' }}>
          Don't have an account?{' '}
          <Link to="/register" style={{ color: '#6366f1', textDecoration: 'none', fontWeight: '600' }}>Register</Link>
        </p>
      </div>
    </div>
  )
